(() => {
    var e = {
            ...
            1554: function(e, t, r) {
                ...
                ! function(o, i) {
                    ...
                    var a = "function",
                        ...
                        J = function(e, t) {
                            ...
                            return this.getBrowser = function() {
                                ...
                                var e = {};
                                return e[p] = i, e[h] = i, X.call(e, n, y.os), x && !e[p] && v && "Unknown" != v.platform && (e[p] = v.platform.replace(/chrome os/i, W).replace(/macos/i, $)), e
                    ...
                    J.VERSION = "1.0.37", J.BROWSER = q([p, h, l]), J.CPU = q([m]), J.DEVICE = q([f, b, d, v, w, y, g, x, S]), J.ENGINE = J.OS = q([p, h]), typeof t !== s ? (e.exports && (t = e.exports = J), t.UAParser = J) : r.amdO ? (n = function() {
                        return J
    ...
    r.amdO = {}, r.n = e => {
        ...
        const b = "production",
            h = "ae1676cfwd2530674p4253c800m34e853cb",
            m = "sae1676cfwd2530674p4253c800m34e853cbm.js";
        ...
        class w extends Error {
            constructor(e, t = {}) {
                var r;
                super(e), this.severity = void 0, this.groupingHash = void 0, this.severity = t.severity || "error", this.groupingHash = null !== (r = t.groupingHash) && void 0 !== r ? r : "Error" === this.name ? void 0 : this.name
            }
        }
        let g = function(e) {
        ...
        const E = (e, t) => {
                    ...
                    try {
                        const t = k().parse(e).reduce(((e, t) => {
                            const r = function({
                                ...
                                var o;
                                return {
                                    file: `https://cdn.shopify.com/cdn/wpm/${m}`,
                                    method: n,
                                    lineNumber: t,
                                    columnNumber: r
                                }
                ...
                const n = function(e, t) {
                    ...
                    try {
                        if (o) {
                            ...
                            if (t && t.length > 2 && (n.lineNumber = t[1], n.columnNumber = t[2], parseInt(n.lineNumber, 10) > 1e5)) throw new O
                        }
                        return {
                            errorClass: e ? .name || r,
                            message: e ? .message || r,
            ...
            R = ["number", "boolean", "symbol"],
            j = (e, {
                context: t
            }) => {
                const r = "v1/" + (t ? `${t}/` : "");
                return null == e || R.includes(typeof e) || Array.isArray(e) ? `${r}UnknownError` : "string" == typeof e ? `${r}${e}` : "groupingHash" in e && "string" == typeof e.groupingHash ? `${r}${e.groupingHash}` : `${r}${"Error"!==e.name&&e.name?e.name:e.message}`
            };
        Error;
        const A = {
                severity: "error",
            ...
            T = {
                metadata: {
                    shopId: -1,
                    surface: g.NotAvailable,
                    browserTarget: y.NotAvailable,
                    shopDomain: "n/a"
                },
                notify: (e, t) => {
                    try {
                        ...
                        if (t ? .options ? .sampleRate && ! function(e) {
                                if (e <= 0 || e > 100) throw new w("Invalid sampling percent", {
                        ...
                        if (r.browserTarget === y.NotAvailable || r.browserTarget === y.Unknown || r.surface === g.NotAvailable || r.surface === g.Unknown || !I(r.shopUrl)) return void(console ? .error && console.error(e));
                        const n = function(e, t) {
                            const {
                                userAgent: r,
                                context: n,
                                ...
                                events: [{
                                    ...
                                    metaData: {
                                        ...
                                        device: {
                                            ...
                                            rendering_engine_name: R.name,
                                            rendering_engine_version: R.version,
        ...
        const D = e => "number" == typeof e ? new _(e) : new Map,
        ...
        function B(e) {
            ...
            function({
                ...
                const r = F(t, e.browser.localStorage);
            ...
            function({
                ...
                const r = F(t, e.browser.sessionStorage);
        ...
        function q(e) {
            const t = new URL(e);
            if ("https:" !== t.protocol) throw new W(`URL must be secure (HTTPS): ${t.href}`);
            if (/^\/api\/.+\/graphql\.json$/.test(t.pathname)) return t;
            const r = z.host.replace(/[/\-\\^$*+?.()|[\]{}]/g, "\\$&");
            if (new RegExp(`^${z.protocol}//(.*@)?${r}`, "i").test(t.href)) throw new $(`Requests are not allowed to the same origin: ${t.href}`);
            return t
        }
        const V = Function.prototype.call.bind(XMLHttpRequest.prototype.open);
        r(2341), r(7872);
        const G = ["constructor", "hasOwnProperty", "toString", "toLocaleString", "valueOf", "isPrototypeOf", "propertyIsEnumerable", "__defineGetter__", "__defineSetter__", "__lookupGetter__", "__lookupSetter__", "__proto__", "apply", "call", "bind"];

        function H(e, t) {
            if (Object.prototype.hasOwnProperty.call(e, t)) return e;
            const r = Object.getPrototypeOf(e);
            return r ? H(r, t) : void 0
        }

        function X(e, t, r) {
            try {
                const n = H(e, t);
                if (!n) throw new w(`No explicit target found for ${t}.`, {
                ...
                if (Array.isArray(r)) {
                    const [n, i] = r;
                    "function" == typeof o && (o = e[t]), Y(o, function(e) {
                        const t = new Set;
                        let r = e;
        ...
        Object.defineProperty(self, "webPixelsManager", {
            value: {
                createShopifyExtend: () => ({
                    extend: async (e, t) => {
                        if ("WebPixel::Render" !== e) throw new J;
                        re = t
                    }
                })
            },
        ...
        (() => {
            try {
                ...
                T.notify(e, {
                    context: `createSandbox/${te}`
                })
            }! function(e, t = self) {
                const r = { ...e ? Z : K,
                    fetch: (n = t.fetch, (e, t) => {
                        const r = new Request(e);
                        return q(r.url), n(r, t)
                    }),
                ...
                }(t.addEventListener)), Y(t, r), Object.freeze(String.prototype), Object.freeze(Request.prototype), Object.freeze(URL.prototype), Object.freeze(RegExp.prototype), N(self, "String", {
                    writable: !1,
                    configurable: !1
                }), N(self, "Request", {
                    writable: !1,
...
globalThis.shopify = self.webPixelsManager.createShopifyExtend('1368227894', 'APP');
importScripts('/web-pixels/strict/app/web-pixel-1368227894@035ee28a6488b3027bb897f191857f56.js');